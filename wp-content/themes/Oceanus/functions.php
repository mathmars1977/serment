...
include ( '../../Oceanus/aq_resizer.php' ); 
include ( '../../Oceanus/getplugins.php' );
include ( '../../Oceanus/guide.php' );


/* Theme updater */
require '../../Oceanus/updater.php';
$example_update_checker = new ThemeUpdateChecker(
	'Oceanus',                                            //Theme folder name, AKA "slug". 
	'http://www.fabthemes.com/versions/oceanus.json' //URL of the metadata file.
); 
